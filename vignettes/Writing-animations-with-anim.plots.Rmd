...
%\VignetteIndexEntry{Writing animations with anim.plots}
-->
...
par(bg="white")
# to update: run knit html, then view in browser, then save to inst/doc
# manually from a terminal, then manually edit HTML to remove absolute 
# references :-(
```
